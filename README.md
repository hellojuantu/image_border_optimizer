...
- [x] 支持图片导出设置修改图片名
- [x] 支持设置切换高清画布
- [x] 支持上传图片可以选择路径（Thanks [@lzy2005](https://github.com/lzy2005) via [PR #10](https://github.com/hellojuantu/image_border_optimizer/pull/10)）
- [ ] 支持导出图片可以选择路径
- [ ] ...
